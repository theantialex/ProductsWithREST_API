...
from products_app.api.app import create_app
from products_app.utils.argparse import clear_environ, positive_int
from products_app.utils.pg import DEFAULT_PG_URL


ENV_VAR_PREFIX = 'PRODUCTS_'
