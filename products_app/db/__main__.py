...
from products_app.utils.pg import DEFAULT_PG_URL, make_alembic_config
...
def main():
    ...
    alembic.parser.add_argument(
        '--pg-url', default=os.getenv('PRODUCTS_APP_PG_URL', DEFAULT_PG_URL),
        help='Database URL [env var: PRODUCTS_APP_PG_URL]'
    )
